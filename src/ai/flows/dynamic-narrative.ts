...
NHIỆM VỤ CỦA BẠN:
1.  **Phân tích hành động của người chơi ({{{playerChoice}}})**. Đánh giá xem nó có sử dụng kỹ năng nào trong {{{skills}}} không.
...
4.  **Dệt nên câu chuyện:** Viết một mô tả cảnh tiếp theo hấp dẫn.
5.  **Cập nhật trạng thái người chơi:** Dựa trên kết quả, cập nhật Máu, Điểm số, và Hành trang. Kỹ năng chỉ thay đổi khi hoàn thành nhiệm vụ. Đặt 'updatedSkills' thành giá trị của 'newSkills' nếu nhiệm vụ hoàn thành, nếu không thì giữ nguyên kỹ năng cũ.
